...
style.scrollbar_unfocus_width = common.round(6 * SCALE)
style.scrollbar_focus_width = common.round(16 * SCALE)
...
style.code_font = renderer.font.load(EXEDIR .. "/data/fonts/monospace.ttf", 14 * SCALE)
